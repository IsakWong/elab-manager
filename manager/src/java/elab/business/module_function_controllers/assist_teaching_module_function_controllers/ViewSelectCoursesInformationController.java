...
public class ViewSelectCoursesInformationController extends BaseFunctionContentController {
    ...
    public void loadDayLabelGroup(HBox WeekRow, int WeekIndex, int DayIndex) {
        try {
            ...
            if(WeekIndex == 0) {
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/business_pages/module_function_pages/assist_teaching_module_function_pages/view_select_courses_information_pages/view_select_courses_column.fxml"));
                ...
                FXMLLoader loader = new FXMLLoader(getClass().getResource("/business_pages/module_function_pages/assist_teaching_module_function_pages/view_select_courses_information_pages/view_select_courses_label.fxml"));
                Label labelGroup = loader.load();
    ...
    public void loadWeekLabelGroup(VBox Container, int WeekIndex) {
        try {
            ...
            FXMLLoader loader = new FXMLLoader(getClass().getResource("/business_pages/module_function_pages/assist_teaching_module_function_pages/view_select_courses_information_pages/view_select_courses_row.fxml"));
